  ...
  return (
    <footer className="flex flex-col items-center mb-8">
      ...
      <div className="flex space-x-4 mb-4">
        <ExternalLink href="https://twitter.com/fabricioism">
        ...
        <ExternalLink href="https://instagram.com/fabricioism">
        ...
        <ExternalLink href="https://github.com/fabricioism">
        ...
        <ExternalLink href="https://www.linkedin.com/in/fabricioism">
